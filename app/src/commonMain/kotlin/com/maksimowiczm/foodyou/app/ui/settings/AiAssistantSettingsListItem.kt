...
@Composable
internal fun AiAssistantSettingsListItem(
    onClick: () -> Unit,
    shape: Shape,
    color: Color,
    contentColor: Color,
    ...
    SettingsListItem(
        ...
        label = { Text(stringResource(Res.string.headline_ai_assistant)) },
        supportingContent = { Text(stringResource(Res.string.description_ai_assistant)) },
        onClick = onClick,
        modifier = modifier,
        shape = shape,
        color = color,
